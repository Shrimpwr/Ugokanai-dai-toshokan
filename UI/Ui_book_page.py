...
class Ui_book_page(object):
    def setupUi(self, book_page):
        ...
        self.DownloadButton = QtWidgets.QPushButton(book_page)
        self.DownloadButton.setGeometry(QtCore.QRect(992, 727, 101, 41))
    ...
    def retranslateUi(self, book_page):
        ...
        self.DownloadButton.setText(_translate("book_page", "下载"))
